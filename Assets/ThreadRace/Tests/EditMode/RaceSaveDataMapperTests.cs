...
namespace ThreadRace.Tests.EditMode
{
    public sealed class RaceSaveDataMapperTests
    {
        ...
        public void RacerProgress_IsPreserved()
        {
            ...
            var restored = Restore(settings, new RaceSaveDataMapper().Capture(settings, session));
        ...
        public void AiCountdowns_ArePreserved()
        {
            ...
            var restoredSaveData = new RaceSaveDataMapper().Capture(settings, Restore(settings, saveData));
        ...
        {
            var restored = Restore(settings, saveData);
            var restoredSave = new RaceSaveDataMapper().Capture(settings, restored);
